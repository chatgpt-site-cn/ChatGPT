...
欢迎来到 [**ChatGPT 中文版**](https://chat.yixiaai.com) 国内使用指南！在这里，您将学会如何**无需翻墙，轻松上手 ChatGPT**。

本指南会详细介绍如何在国内使用 [**ChatGPT 中文版**](https://chat.lanjing.ai)，提供可用的镜像网站，**无限使用GPT-4、4o 和 o1**。
